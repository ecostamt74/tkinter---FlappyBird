...
PIPE_DISTANCE = 250  # Distância mínima entre dois pipes consecutivos
...
class FlappyBird:
    ...
    def check_pipe_collision(self, pipe, bird_coords):
        ...
        return (pipe_coords_top[0] < bird_coords[2] and pipe_coords_top[2] > bird_coords[0] and
                (bird_coords[1] < pipe_coords_top[1] or bird_coords[3] > pipe_coords_bottom[1]))
    ...
    def move_pipes(self):
        ...
        for pipe in self.pipes:
            ...
            if self.canvas.coords(pipe['top'])[0] < 0:  # Se o pipe sair da tela
    ...
    def create_pipe(self):
        ...
        top_pipe = self.canvas.create_rectangle(300, 0, 350, pipe_height, fill=PIPE_COLOR)
        bottom_pipe = self.canvas.create_rectangle(300, pipe_height + PIPE_GAP, 350, CANVAS_HEIGHT, fill=PIPE_COLOR)
